...
id_list: id id_tail;
id_tail: COMMA_OP id id_tail | empty;
...
assign_expr: id ASSIGN_OP expr SEMICOLON_OP;
read_stmt: READ ( id_list ) SEMICOLON_OP;
write_stmt: WRITE ( id_list ) SEMICOLON_OP;
...
expr_list_tail: COMMA_OP expr expr_list_tail | empty;
